...
class UserTest < ActiveSupport::TestCase
  ...
  # This user should be invalid by construstion
  ...
  # Make sure the screen name can't be too short or can't be too long
  ...
  # Make sure the password can't be too short or can't be too long
